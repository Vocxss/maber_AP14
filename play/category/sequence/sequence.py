...
def generate_question(level):
    questions = {
       ...
       14: {"q": f'3, 6, 5, 10, 7, 14, 9, {emoji("cat")}..., berapa nilai {emoji("cat")}?', 
             "a": 18,
             "solusi": "Alternatif Penyelesaian: Selisih bergantian: +2 -> +4."},
       ...
       17: {"q": "Sintara meminjam 2 buku lebih banyak setiap hari.\nHari 1: 2 buku, Hari 2: 4 buku, Hari 3: 6 buku ... Berapa total buku yang dipinjam selama 5 hari?",
             "a": 30,
             "solusi": "Alternatif Penyelesaian: 2 -> 4 -> 6 -> 8 -> 10 = 30."},
       18: {"q": "Setiap hari, Sintara menjual 2× lebih banyak roti lalu +1 bonus. Hari ke-1:2 roti. Berapa roti yang terjual pada hari ke-4?",
             "a": 23,
             "solusi": "Alternatif Penyelesaian: 2 -> 5 -> 11 -> 23."},
       19: {"q": "Toko membeli kain berturut-turut setiap harinya sepanjang 2 m, 6 m, 10 m, 14 m, 18 m selama 5 hari .Hasil dari kain tersebut akan menghasilkan Baju sebanyak 5 baju, 8 baju, 13 baju, 16 baju, 21 baju. Jika tren konstan, berapa baju yang akan jadi pada hari ke-6?",
             "a": 24,
             "solusi": "Alternatif Penyelesaian: Fokus pada baju yang akan jadi (Pola +3 lalu +5, maka 21 -> 24)."},
       20: {"q": f"Atlet berlari berturut-turut setiap hari sejauh 2 km, 4 km, 12 km, 14 km, 42 km, 44 km selama 6 hari. Jika tren konstan, berapa jarak lari yang ditempuh  Atlet pada hari ke-7?",
             "a": 132,
